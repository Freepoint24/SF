...
//на обработку заказов значение забирается из начала очереди в функцию выполнения заказов
//если покупатель передумал, то удаляется соответствующий номер заказа из очереди
